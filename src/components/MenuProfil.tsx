...
export function MenuProfil({
  ...
  return (
    <div
      ref={ref}
      className="monte absolute top-full right-0 z-40 mt-2 w-60 overflow-hidden rounded-xl border border-line bg-deep shadow-2xl"
    >
        ...
        <div className="border-b border-line/70 py-1">
          ...
          {autres.map((p) => (
            <button
              ...
              className="block w-full px-4 py-2 text-left text-[13px] text-muted transition-colors hover:bg-raised hover:text-foam"
            >
              {p.nom}
